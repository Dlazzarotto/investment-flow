...
npm test          # vitest — 31 testes, todos devem passar
...
- Participantes são cadastro (nome, papel, %), não logins; acesso é só do dono do projeto. Login para sócios = futuro `projeto_membros`.
